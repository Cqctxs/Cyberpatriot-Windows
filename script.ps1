...
if ($option -eq 1) {
    New-Item -Path C:\Users\$user\Desktop\files -ItemType directory
    ''
    New-Item -Path C:\Users\$user\Desktop\files\userfiles -ItemType directory
    New-Item -Path C:\Users\$user\Desktop\files\programfiles -ItemType directory
    New-Item -Path C:\Users\$user\Desktop\files\programfilesx86 -ItemType directory
    New-Item -Path C:\Users\$user\Desktop\files\documents -ItemType directory
	New-Item -Path C:\Users\$user\Desktop\files\OS_search_engine -ItemType directory
    Write-Warning "getting user files"
    Get-ChildItem -Path "C:\Users\*" -Include *.jpg,*.png,*.aac,*.ac3,*.avi,*.aiff,*.bat,*.bmp,*.exe,*.flac,*.gif,*.jpeg,*.mov,*.m3u,*.m4p,*.mp2,*.mp3,*.mp4,*.mpeg4,*.midi,*.msi,*.ogg,*.png,*.txt,*.sh,*.wav,*.wma,*.vqf,*.pcap,*.zip,*.pdf,*.json -Recurse | Copy-Item -Destination C:\Users\$user\Desktop\files\userfiles
    Write-Warning "getting program files"
    Get-ChildItem -Path "C:\Program Files\*" -Include *.jpg,*.png,*.aac,*.ac3,*.avi,*.aiff,*.bat,*.bmp,*.exe,*.flac,*.gif,*.jpeg,*.mov,*.m3u,*.m4p,*.mp2,*.mp3,*.mp4,*.mpeg4,*.midi,*.msi,*.ogg,*.png,*.txt,*.sh,*.wav,*.wma,*.vqf,*.pcap,*.zip,*.pdf,*.json -Recurse | Copy-Item -Destination C:\Users\$user\Desktop\files\programfiles
    Get-ChildItem -Path "C:\Program Files (x86)\*" -Include *.jpg,*.png,*.aac,*.ac3,*.avi,*.aiff,*.bat,*.bmp,*.exe,*.flac,*.gif,*.jpeg,*.mov,*.m3u,*.m4p,*.mp2,*.mp3,*.mp4,*.mpeg4,*.midi,*.msi,*.ogg,*.png,*.txt,*.sh,*.wav,*.wma,*.vqf,*.pcap,*.zip,*.pdf,*.json -Recurse | Copy-Item -Destination C:\Users\$user\Desktop\files\programfilesx86
    Write-Warning "getting Documents"
    Get-ChildItem -Path "C:\Users\$user\Documents\*" -Include *.jpg,*.png,*.aac,*.ac3,*.avi,*.aiff,*.bat,*.bmp,*.exe,*.flac,*.gif,*.jpeg,*.mov,*.m3u,*.m4p,*.mp2,*.mp3,*.mp4,*.mpeg4,*.midi,*.msi,*.ogg,*.png,*.txt,*.sh,*.wav,*.wma,*.vqf,*.pcap,*.zip,*.pdf,*.json -Recurse | Copy-Item -Destination C:\Users\$user\Desktop\files\documentsandsettings
    Write-Warning "getting media files"
    Get-ChildItem -Path C:\Users -Include .jpg,.png,.jpeg,.avi,.mp4,.mp3,*.wav -Exclude .dll,.doc,*.docx,  -File -Recurse -ErrorAction SilentlyContinue | Out-File -filepath C:\Users\$user\Desktop\files\Mediafiles.txt
    ...
    '1'
    Start-Sleep -s 1
    net user > files\users.txt
    net localgroup > files\groups.txt
    ...
    $result =$adminAccount.Rename("DefAdmin")
    $guestAccount =Get-WMIObject Win32_UserAccount -Filter "Name='Guest'"
    $result =$guestAccount.Rename("DefGuest")

    #Changing passwords
    Write-Warning "changing passwords to Asecurepassword123!"
    ...
    New-Item -Path C:\Users\$user\Desktop\files\hosts -ItemType directory
    Get-ChildItem -Path "C:\Windows\System32\drivers\etc\hosts" | Copy-Item -Destination C:\Users\$user\Desktop\files\hosts
    ...
    Get-Process | Where-Object {$_.WorkingSet -gt 20000000} > files\interestingprocess.txt
